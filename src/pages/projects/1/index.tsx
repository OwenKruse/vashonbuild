        ...
        <>
            ...
            <div className={Styles.content}>
                <div className={Styles.text}>
                    <p>
                        Architecture and unique finishes were the client goals for this home.  Polished concrete floors, bleached Douglas Fir cabinets, interesting finish ceiling geometry, concrete shower walls, etc make this home a true one of a kind. D&lsquo;Arcy Jones Architecture Design.
                    </p>
                </div>
